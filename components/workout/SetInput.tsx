...
export default function SetInput({
  ...
  useEffect(() => {
    ...
    if (exercise.type === "reps-per-side") {
      const targetPerSide = parseInt(exercise.target.per_side || "10", 10);
      onRepsChange(targetPerSide);
    } else if (exercise.type === "reps" || exercise.type === "reps-sets") {
