...
import { useNextWorkout, useTodaysWorkout } from "@/hooks";
...
export default function HomeScreen() {
  ...
  const [recentSession, setRecentSession] = useState<WorkoutSession | null>(
    null,
  );
  ...
  if (isLoading || isTodaysWorkoutLoading || isNextWorkoutLoading) {
    return (
      <ParallaxScrollView
